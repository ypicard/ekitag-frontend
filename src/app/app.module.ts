...
const appRoutes: Routes = [
...

  {
    ...
    resolve: {
      ...
      pendingMatches: PendingMatchesResolver
    }
  },
  {
    path: "matches/:id",
  ...
  {
    path: "matches_pending/:id",
    component: PendingMatchComponent,
    resolve: { pendingMatch: PendingMatchResolver }
  },
  {
    path: "new_match",
  ...
  },
  {
    ...
    resolve: { player: PlayerResolver, matches: UserMatchesResolver }
  },

  {
    path: "seasons",
    component: SeasonsComponent,
    resolve: { seasons: SeasonsResolver }
  },
  {
    path: "seasons/:id",
...

  {
    ...
    resolve: { rankedPlayers: RankingsResolver }
  },

  {
    path: "specific-rankings",
    component: SpecificRankingsComponent,
    resolve: { seasons: SeasonsResolver }
  },
